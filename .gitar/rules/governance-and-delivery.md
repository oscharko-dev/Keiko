...
actions: "Enable Auto-Apply, repair code-review findings and attributable CI failures on the PR branch, add deterministic tests, and post a redacted progress comment; never unblock, force-push, push to dev, bypass direct required checks, or merge incomplete evidence"
---
...
- Permit native auto-merge only after the exact-head direct required checks succeed.
