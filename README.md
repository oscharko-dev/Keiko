...
If you find a defect while using Keiko, open a GitHub issue with the structured [Bug report form]([https://github.com/oscharko-dev/Keiko/issues/new?template=2.bug.yml](https://github.com/oscharko-dev/Keiko/blob/dev/.github/ISSUE_TEMPLATE/user_finding.yml)). Do not open a blank issue for reproducible bug intake.
