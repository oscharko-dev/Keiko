...
(function () {
  ...
  var G = {
    ...
    /* — AI · models · reasoning — */
    brain: P(ring(12, 12, 7.3, -90, 22)) + P("M12 5 C 10.1 7.2 13.9 9 12 11.4 C 10.1 13.8 13.9 15.6 12 18.9") + P("M8.7 9.8 C 7 10.2 7 13 8.7 13.4") + P("M15.3 9.8 C 17 10.2 17 13 15.3 13.4"),
    brainHalf: P("M12 4.8 A7.2 7.2 0 0 0 12 19.2") + P("M12 6.4 V19.2") + P("M12 9.6 C 10 9.6 10.3 11.8 8.4 11.8") + P("M12 14 C 10.2 14 10.5 15.9 8.9 15.9"),
