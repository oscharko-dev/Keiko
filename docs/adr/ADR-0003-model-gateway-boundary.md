...
tool-catalog binding as a streamed answer, and the retries share the original deadline. A
credential-scoped compatibility memo avoids repeating rejected shapes for 15 minutes. Generic
errors, rejections of another field, and model or content refusals remain terminal; the body-free
compatibility line records only which field was omitted.
