...
Superseded in part — package location (`src/audit/**` → `packages/keiko-evidence`) by ADR-0019; confidentiality negatives (tamper-evidence, encryption-at-rest posture) refined by ADR-0048. The redacted-by-construction evidence-manifest design itself remains the live precedent, actively cited by ADR-0022, ADR-0048, ADR-0107, and ADR-0108.
