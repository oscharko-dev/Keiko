# ADR-0089: Voice assistant speech synthesis — Model Gateway text-to-speech adapter, BFF synthesis route, and audio playback engine
...
- **Issue #1557 (ADR-0088)** extended the provider **capability registry**: the `voice` `ModelKind`,
...
- ADR-0088: Voice provider capability registry extension — the `selectSpeechOutputModel` /
