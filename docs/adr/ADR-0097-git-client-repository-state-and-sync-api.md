# ADR-0097: Git client repository state, history, remotes, and fetch/pull sync API — read-route reuse plus a non-governing sync executor with a sibling evidence ledger
