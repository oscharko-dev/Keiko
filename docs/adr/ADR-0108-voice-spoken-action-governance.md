# ADR-0108: Voice Spoken Action Governance — fail-closed deterministic classification with confirmation binding and content-free audit

> Renumbered from ADR-0066 on 2026-07-04 to resolve the 0058-0069 editor/voice numbering collision (Epic #491 voice series moved to 0100-0111).
...
[ADR-0107](ADR-0107-discussion-intelligence.md) establishes that a `decide`-mode recommendation is
...
[ADR-0107](ADR-0107-discussion-intelligence.md) records the discussion intelligence architecture and
...
- ADR-0103 D10 (render-path wiring for the timing engine).
- ADR-0104 D10 (fixture posture for turn manager render integration).
...
- [ADR-0107](ADR-0107-discussion-intelligence.md) — discussion intelligence; decide-mode recommendation
  sourcing; no-authority guarantee; interrupt-recovery foundation.
- [ADR-0104](ADR-0104-voice-turn-manager.md) — turn manager; floor control; no-authority effect posture.
