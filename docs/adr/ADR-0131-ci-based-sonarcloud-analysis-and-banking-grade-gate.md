...
warning in an unchanged source. `check-sonar-analysis-log.mjs` now verifies both warning-free output
and full-project analysis breadth derived from the scanner's own indexed/analyzed counts. A cached
