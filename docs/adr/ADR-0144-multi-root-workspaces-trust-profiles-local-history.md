# ADR-0144: Multi-root workspaces, Workspace Trust, profiles, and local history
...
ADR-0144 was allocated after refreshing `origin/dev` and all open ADR claims on 2026-07-18.
