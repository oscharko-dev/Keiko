...
The #3411 ADR/gate contract is consolidated into PR #3394 before H1 changes the workspace lane.
Its source identity and verification remain auditable within that integration PR; a separate dev
merge is not a prerequisite. #3414 consumes the reviewed H1 checkpoint defined by ADR-0175 D8
and cannot retroactively authorize a wider lane.
