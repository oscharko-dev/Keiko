...
| Coding Workbench (`coding`)                                                                                                                                 | `widgets/coding-workbench/{CodingWorkbenchWindow,CodingWorkbenchSections,CodingWorkbenchModelCards,codingWorkbenchProjection}.tsx`, `windows/WindowsRegistry.ts`, `lib/api.ts`                                             | empty / running / approval-required / blocked / failed / completed / governed-assist / supervised approval required·approved·denied·stopped·failed / autonomous confirmed·policy-blocked·verification-failed·completed / density full·narrow / dark·light·high-contrast | #1990-#1994                       |
