...
| Card / window     | [#1293](https://github.com/oscharko-dev/Keiko/issues/1293) / [#1294](https://github.com/oscharko-dev/Keiko/issues/1294) / [#2060](https://github.com/oscharko-dev/Keiko/issues/2060) | [fidelity-matrix.md](fidelity-matrix.md)               | `--card-*` / `--surface-*`                                  | Default, Focus, Selected, Loading, Syncing, Conflict              | Hover, Active, Disabled, Error, Empty              | titled region; selected state is exposed in the accessible name plus a live selection count; loading/syncing/conflict carry icon + word; focusable when interactive | [`evidence/1293/`](evidence/1293/README.md), [`evidence/2060/`](evidence/2060/README.md) |
