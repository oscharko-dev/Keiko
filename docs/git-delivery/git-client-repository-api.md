...
[ADR-0097](../adr/ADR-0097-git-client-repository-state-and-sync-api.md). It is written for engineers
...
- **Fetch/pull do NOT enter the governed mutation taxonomy.** `GitDeliveryActionKind` carries no
  ...
  [ADR-0097](../adr/ADR-0097-git-client-repository-state-and-sync-api.md) D4.
