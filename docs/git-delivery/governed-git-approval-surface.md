...
[ADR-0060](../adr/ADR-0060-governed-git-approval-and-preview-surface.md). It is written for engineers
...
([ADR-0058](../adr/ADR-0058-governed-git-delivery-contracts.md)) and the execution and preflight
kernel from Issue #472 ([ADR-0059](../adr/ADR-0059-governed-git-mutation-execution-kernel.md), see
