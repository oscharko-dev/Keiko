...
[ADR-0061](../adr/ADR-0061-governed-git-mutation-evidence-ledger.md). It is written for engineers
...
Issue #471 (ADR-0058) defined the typed contract surface, Issue #472 (ADR-0059) built the execution
kernel that drives every mutation through one repeatable lifecycle and returns a structured
`GitMutationLifecycleResult`, and Issue #473 (ADR-0060) built the approval and preview presentation
