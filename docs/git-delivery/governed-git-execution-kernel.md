...
[ADR-0059](../adr/ADR-0059-governed-git-mutation-execution-kernel.md). It is written for engineers
...
typed contracts from Issue #471 (ADR-0058) and drives every supported mutation through one repeatable
lifecycle:
