...
Epic #470 · ADR-0064 · builds on the #476 governed remote publish gateway.
...
## Transport and the token boundary (ADR-0064 D2)
...
## Content-free guarantee (ADR-0064 D3)
...
## Readiness ≠ merge-readiness (ADR-0064 D4)
