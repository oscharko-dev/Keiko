...
[ADR-0062](../adr/ADR-0062-governed-local-git-flows-and-commit-intent.md). It is written for engineers
...
([ADR-0058](../adr/ADR-0058-governed-git-delivery-contracts.md)), the execution and preflight kernel
from Issue #472 ([ADR-0059](../adr/ADR-0059-governed-git-mutation-execution-kernel.md), see
