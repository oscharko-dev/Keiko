...
- Governing decision: [ADR-0134](../adr/ADR-0134-governed-debug-adapter-session-management.md).
...
| ----- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| #2342 | ADR-0134 defines the governed Node.js/TypeScript DAP architecture, ownership, limits, failure modes, and non-goals.                                                              | `docs/adr/ADR-0134-governed-debug-adapter-session-management.md`; `npm run check:adr-index`                                      | Implemented; local architecture index passed.                            |
...
| #2344 | Stateless, closed, operator-provisioned capsule launch planning remains separate from session ownership.                                                                         | ADR-0134 ownership rules; DAP production, launch-plan, and sandbox tests in `npm test`                                           | Implemented; full suite passed.                                          |
