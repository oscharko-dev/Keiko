...
| Eval fixtures           | passed | `npm test -- --run packages/keiko-evaluations/src/local-knowledge/fixtures.test.ts packages/keiko-evaluations/src/local-knowledge/runner.test.ts`                                                                                                                                                                                                                                                                                               |
