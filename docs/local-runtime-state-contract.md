...
| Activity logs (`logs/server.log`, including the CLI control root)                                                  | yes              | yes                | deferred                                  | yes (7 days)   | n/a                                                                               | [ADR-0173](adr/ADR-0173-server-activity-log-v2-machine-reconstruction-contract.md)                      |
