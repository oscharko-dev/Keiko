...
| Activity logs (`logs/` segments, including the CLI control root)                                         | yes              | yes                         | deferred                                  | yes (256 MiB and 14 days by default, plus a 64 MiB pin quota) | n/a                                                                               | [ADR-0173](adr/ADR-0173-server-activity-log-v2-machine-reconstruction-contract.md)                      |
