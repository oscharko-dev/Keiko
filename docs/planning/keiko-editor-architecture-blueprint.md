...
- **`monaco-languageclient` is not adopted by default.** Monaco's bundled workers plus the server
  ...
  server bridge enters scope (e.g. the #1213 multi-language expansion, now planned in
  [ADR-0045](../adr/ADR-0045-staged-multi-language-lsp-expansion.md)), after dependency review (§12).
...
| `monaco-languageclient`                          | —                                            | —       | **Not adopted by default**                                                                  | Monaco's bundled `ts.worker` + the server TS language service cover v1 without LSP/JSON-RPC. Reconsider only for an out-of-process LSP bridge (#1213, planned in [ADR-0045](../adr/ADR-0045-staged-multi-language-lsp-expansion.md)), after dependency review (fit, maintenance, size, security, Keiko-architecture compatibility). |
| Out-of-process LSP servers (Java/Python/Rust/Go) | —                                            | —       | **Planned** ([ADR-0045](../adr/ADR-0045-staged-multi-language-lsp-expansion.md); #1213, P2) | Staged multi-language expansion governed by ADR-0045; not v1.                                                                                                                                                                                                                                                                       |
...
- **Staged expansion** ([#1213](https://github.com/oscharko-dev/Keiko/issues/1213), **P2, deferred**):
  ...
  Now planned in [ADR-0045](../adr/ADR-0045-staged-multi-language-lsp-expansion.md) and
  [docs/planning/keiko-editor-multi-language-expansion.md](keiko-editor-multi-language-expansion.md).
