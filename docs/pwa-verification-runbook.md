...
Status: historical. ADR-0122 suppresses browser-managed PWA installation for portable-first
...
- Node.js `>=24.18.0 <25 || >=26.3.0 <27` and npm `>=11.16.0 <12` installed (see
