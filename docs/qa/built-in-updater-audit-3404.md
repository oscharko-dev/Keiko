...
## Appendix A — exhaustive updater-surface inventory

The corrected command below produced 194 paths at audited HEAD. The marker-bounded inventory accounts for each
...
consumers, and disposition for every following path.
