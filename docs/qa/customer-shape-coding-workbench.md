...
**Ask for approval**,
and starts a turn. The gateway is a local LiteLLM/vLLM-shaped twin: it rejects streamed
...
contain request validation and the compatibility retry. It reports duration and no prompt body.
