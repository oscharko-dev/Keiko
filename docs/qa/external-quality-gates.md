...
Keiko for Quality is retired by [ADR-0176](../adr/ADR-0176-retire-keiko-for-quality.md). It has
no workflow, review profile, repository variable, credential, or protected environment here, and no
model-backed reviewer runs on a pull request in this repository.
