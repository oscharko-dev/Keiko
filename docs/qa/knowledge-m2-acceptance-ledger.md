...
| The native addon needed a worker import forbidden by ADR-0019.                                                        | Resolved by ADR-0019 v1.1 and ADR-0164's exact two-file exception; every other worker/network/process import remains denied.                                            |
...
ADR-0164; their invariants are not relaxed.
