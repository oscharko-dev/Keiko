...
Every stable portable release that advertises portable delivery is release-blocked on exactly four
...
| `linux-x64`   | `keiko-linux-x64.zip`   | First-class, release-blocking | `packages/keiko-contracts/src/update-session.test.ts`, `scripts/__tests__/portable-runtime.test.mjs`, `scripts/__tests__/release-publish-pipeline.test.mjs`, `scripts/__tests__/portable-launch-setup-smoke.test.mjs`.                                                                                                                              |
...
| ------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Portable target contract       | `packages/keiko-contracts/src/update-session.test.ts`, `scripts/__tests__/portable-runtime.test.mjs`                                                                                                                               | Exactly four supported targets and their asset names are canonical. Target or asset-name drift fails.                                                                                               |
| Release/publish asset gate     | `scripts/release-publish.mjs`, `scripts/__tests__/release-publish-pipeline.test.mjs`, `scripts/__tests__/release-portable-assets-workflow.test.mjs`                                                                                | Stable latest publishes require a reviewed portable asset bundle, exactly four target artifacts, safe manifest paths, verified upload/download URLs, and no symlink/traversal inputs.               |
