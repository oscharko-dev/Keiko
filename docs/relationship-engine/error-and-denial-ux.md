...
| `denied/invalid-structure`             | "The relationship envelope is malformed."                                                 | Creation banner + inspector denial.                                      | Yes.                                        | [denial-reasons.md](denial-reasons.md) structural validation.                                                                |
...
| ---------------- | ----------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Skeleton**     | `.rv-skel` / `.rv-loading` skeleton blocks ([518-ui-blueprint.md "Visual state catalogue"](../workspace/518-ui-blueprint.md)) | List loads, inspector section loads, audit history page load. Renders after 500 ms threshold to avoid flash.                                                                          |
