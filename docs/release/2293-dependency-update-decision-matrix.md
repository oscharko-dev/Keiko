...
| `eslint`                         |                    10.6.0 |           9.39.5 | Normalized to the latest stable peer-valid release. ESLint 10.7.0 was rejected because three current `eslint-config-next` plugins declare only ESLint <=9; accepting npm's override would leave `npm ls` invalid. |
| `@eslint/js`                     |                    10.0.1 |           9.39.5 | Aligned with the peer-valid ESLint major; no lint policy is removed.                                                                                                                                              |
