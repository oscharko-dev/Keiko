...
| `vitest`                      | root                  | 5.0.0   | current        | Realigned here; the keiko-ui nested copy is gone and both resolve to this node. Major taken with dependabot #3459 (PR #3452): `bench` moves from a top-level export to a test-context fixture and jest-dom matchers gain a return value; both carried in the same PR. |
| `vitest`                      | keiko-ui              | 5.0.0   | current        | Resolves to the root node; the workspace no longer carries its own copy. Major taken with dependabot #3459 (PR #3452), in step with the root.                                                                                                                         |
| `@vitest/coverage-v8`         | root                  | 5.0.0   | current        | Exact peer match for Vitest 5.0.0 (its declared peer range is the exact version); a mismatch here made `npm ls` invalid. Major taken with dependabot #3460 (PR #3452), in step with vitest 5.                                                                         |
