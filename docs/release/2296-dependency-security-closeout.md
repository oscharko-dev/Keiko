...
checkout-bound rows were refreshed on 2026-09-17 against the dependency-rollup branch based on
`dev`.
...
| Source                     | Result                                                                     |
| -------------------------- | -------------------------------------------------------------------------- |
| `npm audit --json`         | 0 vulnerabilities across 987 resolved packages (99 prod, 867 dev, 147 opt) |
...
| `autoprefixer`                | keiko-ui              | 10.5.5  | patch-deferred | Fixes resolution-media-query parsing performance. The later 10.6 line was not part of the reviewed Dependabot queue and remains a separate update.                                                                                                                    |
