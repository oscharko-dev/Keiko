...
| `@vitest/coverage-v8`         | root                  | 5.0.0   | current        | Exact peer match for Vitest 4.1.11; a mismatch here made `npm ls` invalid. Major taken with dependabot #3460 (PR #3452), in step with vitest 5.                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| `@types/react-dom`            | keiko-ui              | 19.2.7  | patch-deferred | Declarations only; 19.2.5 available. Taken with dependabot #3458 (PR #3452).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
