...
| `typescript-eslint`           | root                  | 8.69.0  | patch-deferred | Taken with the deferred work it demanded: `no-meaningless-void-operator` tightened in 8.69.0 and flagged all 59 `void <identifier>` unused-suppression idioms, each moved to the `_` marker the root ESLint config already declares. 8.70.0 published after this branch took 8.69.0 and is deliberately not taken here — adopting it would invalidate the D12 and tool-catalog reference measurements this branch already carries and re-run the full matrix for a release nothing in it needs. Not `current`: the registry, not the lockfile, defines that, which is the blind spot recorded below. |
...
| `@types/react`                | keiko-ui              | 19.2.18 | patch-deferred | 19.3.0 available and not taken, in step with `@types/react-dom`; the pair moves together.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| `@types/node`                 | root                  | 26.4.1  | current        | Root declarations realigned with the UI workspace on the Node 26 line.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `@types/node`                 | keiko-ui              | 26.4.1  | current        | Node 26 declaration refresh for the UI workspace; resolves with the root node.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `@types/react-dom`            | keiko-ui              | 19.2.7  | patch-deferred | Declarations only; 19.3.0 available and not taken, to keep the React type pair on one line. Taken with dependabot #3458 (PR #3452).                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| `knip`                        | root                  | 6.34.0  | current        | Patch refresh for the required `check:knip` gate.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
not change what the required checks execute while it is establishing what they executed. The
