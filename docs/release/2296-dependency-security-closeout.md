...
| `next`                        | keiko-ui              | 16.3.3  | current        | Taken 2026-09-08 for GHSA-2xp9-vwfh-vxw4 (CVSS 9.5) and GHSA-p293-qw3h-jr36 (CVSS 9.0, RCE on Windows-hosted servers), both fixed in 16.3.3, together with `eslint-config-next`. |
