...
- [ADR-0115: Portable managed install and release-asset update authority](../adr/ADR-0115-portable-managed-install-and-release-asset-update-authority.md)
...
- The release-impact entry must bind the full reviewed ADR-0115 tuple for the same artifact:
