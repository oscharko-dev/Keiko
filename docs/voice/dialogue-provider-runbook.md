...
switch and the session, fail-closed (ADR-0090 D3). In capability terms:
...
browser without WebRTC media the session transparently falls back to the STT+TTS turn loop (ADR-0090 D3).
...
- **ADRs:** [ADR-0088](../adr/ADR-0088-voice-provider-capability-registry-extension.md),
  [ADR-0089](../adr/ADR-0089-voice-assistant-speech-synthesis.md),
