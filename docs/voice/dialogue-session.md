...
[ADR-0090](../adr/ADR-0090-voice-dialogue-session-orchestration.md).
...
offers dialogue for. See [ADR-0090](../adr/ADR-0090-voice-dialogue-session-orchestration.md) D4.
...
**production fallback fix** (ADR-0090 D3): regulated deployments expose speech I/O without full-duplex
...
## Realtime-transcript deferral (ADR-0090 D8)
...
- [ADR-0090](../adr/ADR-0090-voice-dialogue-session-orchestration.md) — the orchestration decision record.
- [ADR-0062](../adr/ADR-0062-voice-turn-manager.md) — the deterministic turn manager this controller drives live.
- [ADR-0089](../adr/ADR-0089-voice-assistant-speech-synthesis.md) / [assistant-speech-synthesis.md](assistant-speech-synthesis.md) — the speech engine and its `turnManager` / `interrupt` seam.
