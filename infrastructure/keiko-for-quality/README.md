...
what lets the sweep skip a settled, unchanged pull request without re-fetching its evidence. Do not
replace this binding with Workers KV: the Free-plan KV write ceiling is lower than the webhook volume
generated by concurrent large pull requests.
