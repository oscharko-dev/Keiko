...
// identically to editor-completion.ts and (except isCostClass) editor-test-generation.ts.
// isPositiveInteger stays local -- it is unique to this file's maxOutputTokens field.
