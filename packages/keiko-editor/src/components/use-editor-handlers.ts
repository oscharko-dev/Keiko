...
import {
  ...
  type MountEditor,
  type MountMonaco,
  type WireEditorCommands,
  type WireEditorCodeActions,
  type WireEditorCompletion,
  type WireEditorDefinition,
  type WireEditorDiagnostics,
  type WireEditorFormatting,
  type WireEditorHover,
  type WireEditorInlineCompletion,
  type WireEditorInlayHints,
  type WireEditorCallHierarchy,
  type WireEditorReferences,
  type WireEditorSignatureHelp,
  type WireEditorSymbols,
  type WireEditorGitGutter,
