// Deterministic transcript-segment builders for the voice-recap fixtures (Epic #491, Issue #504).
//
...
// a partial / discarded / superseded segment physically present in a fixture cannot reach the candidate
// model — rather than asserting it. These builders are pure data factories: no IO, clock, or randomness.
