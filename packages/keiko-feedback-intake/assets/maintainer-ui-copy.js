...
const ENGLISH_PUBLICATION_COPY = {
...
const GERMAN_PUBLICATION_COPY = {
  ...
  approveHelp: "Eine menschliche Freigabe stellt genau diese Vorschau zur Veröffentlichung bereit.",
...
function publicationDictionaries() {
  return { english: ENGLISH_PUBLICATION_COPY, deutsch: GERMAN_PUBLICATION_COPY };
}
