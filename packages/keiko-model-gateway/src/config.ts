...
// #1557, ADR-0088 D2): `persona` ∈ VOICE_PERSONAS, `voiceId` a non-empty trimmed string. The
...
// (Issue #1557, ADR-0088 D2 / HAZARD-1): validates against the MERGED capability (not the inline
