...
// Speech-output model selection (Issue #1557, ADR-0088 D6). Returns the configured voice provider
...
// Server-side persona → voice-id resolver (Issue #1557, ADR-0088 D6) — the seam Issue #1558 consumes.
