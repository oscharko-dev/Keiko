...
// (ADR-0058 D7, ADR-0089). Only the synthesized audio bytes and their content-type escape this
...
// can map it to a deterministic, secret-free HTTP response (ADR-0089, AC4). On success the audio
