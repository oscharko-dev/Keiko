...
// The sensitive persona → provider-voice-id mapping (Issue #1557, ADR-0088 D2). `voiceId` is a
...
export interface ModelProviderConfig {
  ...
  // Persona → provider voice-id mapping for this voice provider (Issue #1557, ADR-0088 D2). Present
