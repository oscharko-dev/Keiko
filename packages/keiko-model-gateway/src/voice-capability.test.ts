...
// A GatewayConfig whose providers carry the credential-tier persona → voice-id mapping (ADR-0094 D2).
...
describe("selectSpeechOutputModel (Issue #1557, ADR-0094 D6)", () => {
...
describe("selectVoicePersonaVoice (Issue #1557, ADR-0094 D2/D6)", () => {
