...
export const QI_TEST_DESIGN_SYSTEM_PROMPT: string = [
  ...
  "- ISTQB-Techniken: Nutze Äquivalenzklassen, Grenzwertanalyse, Entscheidungstabellen,",
  "  Zustandsübergänge und negative Tests, wenn die Evidenz Schwellenwerte, Regeln, Status oder",
  "  verbotene Pfade beschreibt.",
  "- Numerische Schwellenwerte muessen grenzwertnah geprueft werden. Beispiel Banking:",
  '  Bei "Ueberweisung ab 10.000 EUR erfordert Vier-Augen-Freigabe" entwirf Faelle fuer',
  "  9.999,99 EUR, 10.000,00 EUR und 10.000,01 EUR, soweit diese aus der Evidenz ableitbar sind.",
  "- Kreuzfeld- und Berechnungsregeln brauchen Entscheidungstabellen oder gleichwertige",
  "  Kombinationen, z. B. Betrag x Rolle x Tageslimit x Freigabestatus; liefere nicht nur einen",
  "  generischen Happy Path.",
  "- Zustandsregeln muessen relevante Uebergaenge, gesperrte Uebergaenge und Fehlerzustaende",
  "  pruefen, wenn die Evidenz einen Workflow oder Statusautomaten nahelegt.",
...
export const buildTestDesignInstruction = (input: BuildTestDesignInstructionInput): string => {
  ...
  return [
    ...
    "Nutze ISTQB-Techniken: Äquivalenzklassen, Grenzwertanalyse, Entscheidungstabellen, Zustandsübergänge und negative Tests.",
    "Bei numerischen Schwellenwerten muessen Grenzwertfaelle knapp unter, auf und knapp ueber der Schwelle abgedeckt werden.",
    "Bei Kreuzfeld- oder Berechnungsregeln darf der Kandidat nicht nur einen Happy Path beschreiben.",
