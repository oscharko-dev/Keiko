...
// ADR-0088 D2 / HAZARD-3). It must NOT be persisted: the strict top-level `capabilities` parser
...
// stripped and re-derived on reload — ADR-0088 D2) is pinned directly against this function.
