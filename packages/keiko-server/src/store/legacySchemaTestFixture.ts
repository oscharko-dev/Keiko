...
//
// V20/V30/V33 have no fragments: they only widen a `failure_code` CHECK on
...
const ROLLBACKS: readonly VersionRollback[] = [
  {
    version: 35,
    sql: `
      DROP TABLE coding_history_message_bindings;
      DROP TABLE coding_history_runs;
      DROP TABLE coding_history_tasks;
    `,
  },
  {
    version: 34,
