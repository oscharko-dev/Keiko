...
// manual step below. It has one fixture-shape assertion and no timing threshold — `vitest bench`
// reports timings, it does not pass/fail on them. Run manually with
...
describe("parseGitdirPointerTarget bench (S8786, shared Git identity)", () => {
  test("extracts the target from the padded fixture", () => {
