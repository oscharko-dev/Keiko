 ...
 * correctly with a REAL domain handler and a REAL authority port -- mode coverage, approval
 * consumption, hard denials, and revocation. The real-request-reachable adapter coverage lives in
 * catalogToolFacadeBridge.test.ts and codingToolAuthorityPort.test.ts.
 */
