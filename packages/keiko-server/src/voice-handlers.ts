...
// ---------------------------------------------------------------------------
// BFF assistant speech-output (synthesis) route (Issue #1558, Epic #1556, ADR-0089).
...
// Resolves the model + provider voice id to synthesize with (Issue #1557 seam, ADR-0088 D6). A
