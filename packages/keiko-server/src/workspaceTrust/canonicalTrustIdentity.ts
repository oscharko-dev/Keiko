// Issue #2521/#2524, ADR-0147 D1/D3 — pure derivation of WorkspaceTrustBinding from a
...
// (ADR-0147 D1). Derivation is deterministic: the same canonical root yields the same references and
