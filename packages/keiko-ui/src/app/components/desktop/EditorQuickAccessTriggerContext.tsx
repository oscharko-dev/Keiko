...
/**
 * Lets the editor's own container-level capturing keydown listener (`EditorWidget.tsx`) invoke
 * shell-owned editor shortcuts directly, bypassing
 ...
 * anywhere"). The same seam carries Editor settings: the editor remains responsible only for
 * recognising an editor-context chord, while the shell retains the one action that opens and
 * focuses the settings surface.
 */
