// Issue #1560, Epic #1556 (ADR-0090) — the PURE, React-free, I/O-free core of the voice dialogue
...
// conjunction is true only for the `full-realtime` profile (ADR-0090 D2) — identical whether or not the
