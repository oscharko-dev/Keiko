...
const EN_EDITOR_AGENT_MESSAGES = {
  ...
  "chat.restoration.chooseOpen": "Open {title}",
  ...
  "actions.action.requestVerification": "Request verification",
...
const DE_EDITOR_AGENT_MESSAGES = {
  ...
  "chat.restoration.chooseOpen": "{title} öffnen",
  ...
  "actions.action.requestVerification": "Verifizierung anfordern",
