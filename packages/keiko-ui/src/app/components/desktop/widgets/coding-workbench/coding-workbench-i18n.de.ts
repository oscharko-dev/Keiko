...
export const DE_CODING_WORKBENCH_MESSAGES = {
  ...
  "codingWorkbench.progress.workingHelp": "Der Coding-Agent bearbeitet diese Aufgabe.",
  "codingWorkbench.progress.approval": "Wartet auf deine Freigabe",
  "codingWorkbench.progress.approvalHelp": "Prüfe die vorgeschlagene Aktion, damit es weitergeht.",
  "codingWorkbench.progress.question": "Deine Antwort wird benötigt",
  "codingWorkbench.progress.questionHelp": "Der Coding-Agent hat eine Rückfrage zur Aufgabe.",
  "codingWorkbench.progress.paused": "Pausiert",
  "codingWorkbench.progress.pausedHelp": "Setze die Aufgabe fort, sobald du bereit bist.",
  "codingWorkbench.progress.done": "Antwort abgeschlossen",
  "codingWorkbench.progress.doneHelp":
    "Schreibe eine Folgefrage für diese Aufgabe oder starte eine neue.",
  "codingWorkbench.progress.failed": "Aktion erforderlich",
  "codingWorkbench.progress.failedHelp": "Prüfe den angezeigten Fehler vor dem Fortsetzen.",
  "codingWorkbench.progress.stopped": "Lauf beendet",
  "codingWorkbench.progress.stoppedHelp":
    "Der gespeicherte Verlauf bleibt in der Coding History erhalten.",
  "codingWorkbench.progress.ready": "Keine Aufgabe läuft",
  "codingWorkbench.progress.readyHelp": "Beschreibe den nächsten Schritt im Eingabefeld.",
