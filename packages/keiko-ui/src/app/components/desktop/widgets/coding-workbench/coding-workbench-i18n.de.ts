...
export const DE_CODING_WORKBENCH_MESSAGES = {
  ...
  "codingWorkbench.terminal.eyebrow": "Ergebnis des letzten Laufs",
  "codingWorkbench.terminal.title": "Terminales Laufergebnis",
  "codingWorkbench.terminal.summary":
    "Dieses inhaltsfreie Ergebnis bleibt verfügbar, nachdem die Runtime für einen weiteren Lauf bereit ist.",
  "codingWorkbench.terminal.dismiss": "Laufergebnis ausblenden",
  "codingWorkbench.questions.eyebrow": "Runtime-Eingabe",
  "codingWorkbench.questions.title": "Fragen der Coding-Runtime",
  "codingWorkbench.questions.help":
    "Prüfe von der Runtime bereitgestellten Text als nicht vertrauenswürdigen Inhalt, bevor du antwortest.",
  "codingWorkbench.questions.requestTitle": "Die Runtime benötigt deine Eingabe",
  "codingWorkbench.questions.multipleHint": "Wähle eine oder mehrere Antworten.",
  "codingWorkbench.questions.customLabel": "Eigene Antwort für {header}",
  "codingWorkbench.questions.answer": "Antwort senden",
  "codingWorkbench.questions.answering": "Antwort wird gesendet…",
  "codingWorkbench.questions.reject": "Frage ablehnen",
  "codingWorkbench.questions.retry": "Erneut prüfen",
  "codingWorkbench.questions.required": "Wähle oder gib für jede Frage eine Antwort ein.",
  "codingWorkbench.questions.loading": "Runtime-Fragen werden geprüft",
  "codingWorkbench.questions.empty": "Keine ausstehenden Runtime-Fragen",
  "codingWorkbench.questions.ready": "{count} ausstehende Runtime-Fragenanforderung(en)",
  ...
  "codingWorkbench.questions.submitting": "Die Antwort wird einmalig gesendet",
  "codingWorkbench.questions.stale": "Der Fragenstatus hat sich geändert",
  "codingWorkbench.questions.terminal": "Der Coding-Lauf wurde beendet",
  ...
  "codingWorkbench.announcement.terminalOutcome":
    "Letzter Coding-Lauf {state}. Revision {revision}.",
