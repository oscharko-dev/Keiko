...
const LOCAL_KNOWLEDGE_EN_MESSAGES = {
  ...
  "localKnowledge.detail.index.noChunksAvailable": "No chunks available for embedding",
...
const LOCAL_KNOWLEDGE_DE_MESSAGES: LocalKnowledgeMessageCatalog = {
  ...
  "localKnowledge.detail.index.noChunksAvailable": "Keine Chunks für Embeddings verfügbar",
