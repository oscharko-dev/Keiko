...
export const DE_MESSAGES = {
  ...
  "quickAccess.empty.noRoot": "Öffnen oder wählen Sie ein Projekt, um Dateien zu durchsuchen.",
  "quickAccess.empty.startSearch": "Tippen Sie, um Dateien im Projekt zu suchen.",
  "quickAccess.empty.files": "Keine passenden Dateien.",
  "quickAccess.title": "Schnellzugriff",
  "quickAccess.description": "Dateien suchen oder einen Befehl ausführen.",
  "quickAccess.query.commands": "Befehle suchen",
  "quickAccess.query.files": "Dateien suchen",
  "quickAccess.placeholder.commands": "Befehl eingeben…",
  "quickAccess.placeholder.files": "Projektdateien durchsuchen…",
