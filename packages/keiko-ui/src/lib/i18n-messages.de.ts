...
export const DE_MESSAGES = {
  ...
  "editor.agentConflict.title.dirty": "Konflikt mit ungespeicherten Änderungen",
  "editor.agentConflict.title.versionMismatch": "Abweichende Dateiversion",
  "editor.agentConflict.title.contentHashMismatch": "Abweichender Dateiinhalt",
  "editor.agentConflict.title.invalidEdits": "Ungültige Agentenänderungen",
  "editor.agentConflict.title.outOfScope": "Aktion außerhalb des zulässigen Bereichs",
  "editor.agentConflict.title.noActiveSession": "Keine aktive Editorsitzung",
  "editor.agentConflict.title.noActiveBridge": "Keine aktive Editorverbindung",
  "editor.agentConflict.title.preconditionRequired": "Schreibvorbedingung fehlt",
  "editor.agentConflict.title.policyDenied": "Aktion durch Richtlinie abgelehnt",
  "editor.agentConflict.title.approvalRequired": "Aktion muss genehmigt werden",
  "editor.agentConflict.reload": "Neu laden",
  "editor.agentActions.panelLabel": "Letzte Agentenaktionen im Editor",
  "editor.agentActions.title": "Letzte Agentenaktionen",
  "editor.agentActions.filterGroup": "Letzte Agentenaktionen filtern",
  "editor.agentActions.filter.actionType": "Aktionstyp",
  "editor.agentActions.filter.disposition": "Einstufung",
  "editor.agentActions.filter.timeRange": "Zeitraum",
  "editor.agentActions.action.all": "Alle Aktionstypen",
  "editor.agentActions.action.openFile": "Datei öffnen",
  "editor.agentActions.action.focusTab": "Tab fokussieren",
  "editor.agentActions.action.moveTab": "Tab verschieben",
  "editor.agentActions.action.splitPane": "Bereich teilen",
  "editor.agentActions.action.setSelection": "Auswahl setzen",
  "editor.agentActions.action.format": "Formatieren",
  "editor.agentActions.action.save": "Speichern",
  "editor.agentActions.action.applyTextEdits": "Textänderungen anwenden",
  "editor.agentActions.action.applyPatch": "Patch anwenden",
  "editor.agentActions.action.applyChangeset": "Änderungssatz anwenden",
  "editor.agentActions.disposition.all": "Alle Einstufungen",
  "editor.agentActions.disposition.allowed": "Zugelassen",
  "editor.agentActions.disposition.reviewRequired": "Prüfung erforderlich",
  "editor.agentActions.disposition.denied": "Abgelehnt",
  "editor.agentActions.timeRange.all": "Gesamter Zeitraum",
  "editor.agentActions.timeRange.pastHour": "Letzte Stunde",
  "editor.agentActions.timeRange.pastDay": "Letzte 24 Stunden",
  "editor.agentActions.timeRange.pastWeek": "Letzte 7 Tage",
  "editor.agentActions.loadError": "Letzte Agentenaktionen konnten nicht geladen werden.",
  "editor.agentActions.empty": "Keine letzten Agentenaktionen im Editor.",
  "editor.agentActions.noMatch": "Keine Agentenaktion entspricht den aktuellen Filtern.",
  "editor.agentActions.rowTarget": " in {path}",
  "editor.agentActions.rowReason": " ({reason})",
  "editor.agentActions.rowSummary": "{action}{target}: {disposition}, {outcome}{reason}",
