...
export const DE_MESSAGES = {
  ...
  "codingWorkbench.status.checking": "Pruefe",
  "codingWorkbench.status.available": "Verfuegbar",
  "codingWorkbench.status.unavailable": "Nicht verfuegbar",
  "codingWorkbench.runtime.gatewayManagedDetail": "Verwalteter Provider ueber Keiko Gateway",
  "codingWorkbench.runtime.gatewayApiKeyDetail": "API-Schluessel ueber Keiko Gateway geroutet",
  "codingWorkbench.runtime.codexDetail":
    "Subscription-Profil laeuft ueber den Codex-Runtime-Adapter",
  ...
  "workspace.selection.none": "Keine Arbeitsbereichsfenster ausgewaehlt",
  "workspace.selection.one": "1 Arbeitsbereichsfenster ausgewaehlt",
  "workspace.selection.many": "{count} Arbeitsbereichsfenster ausgewaehlt",
  "workspace.window.selectedLabel": "{label} — ausgewaehlt",
  "chat.role.user": "Du",
