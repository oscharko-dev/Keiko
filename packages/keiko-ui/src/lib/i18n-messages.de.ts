...
export const DE_MESSAGES = {
  ...
  "feedback.subtitle":
    "Erstelle einen lokalen Report, pruefe den redigierten Payload und sende ihn dann an die Intake-Queue.",
  "feedback.githubLink": "Public GitHub Issue",
  "feedback.category": "Kategorie",
  "feedback.category.bug": "Bug",
  "feedback.category.crash": "Crash",
  "feedback.category.performance": "Performance",
  "feedback.category.usability": "Usability",
  "feedback.category.documentation": "Dokumentation",
  ...
  "feedback.severity.critical": "Kritisch",
  "feedback.field.title": "Titel",
  "feedback.field.description": "Beschreibung",
  "feedback.field.steps": "Reproduktionsschritte",
  "feedback.field.expected": "Erwartet",
  "feedback.field.actual": "Tatsaechlich",
  "feedback.field.featureArea": "Feature-Bereich",
  "feedback.action.preview": "Vorschau",
  "feedback.action.previewing": "Vorschau wird erstellt...",
  "feedback.action.submit": "Feedback senden",
  "feedback.action.submitting": "Wird gesendet...",
  "feedback.status.previewing": "Redigierte Vorschau wird erstellt...",
  "feedback.status.previewReady": "Vorschau bereit. Pruefe den Payload vor dem Senden.",
  "feedback.status.previewBlocked": "Vorschau ist blockiert und kann nicht gesendet werden.",
  "feedback.status.submitting": "Redigiertes Feedback wird gesendet...",
  "feedback.status.submitted": "Feedback an Intake gesendet: {intakeId}",
  "feedback.intakeStatus.new": "Neu",
  "feedback.intakeStatus.duplicate": "Duplikat",
  "feedback.intakeStatus.rejected": "Abgelehnt",
  "feedback.intakeStatus.follow-up-requested": "Rueckfrage angefordert",
  "feedback.intakeStatus.approved-for-github": "Fuer GitHub freigegeben",
  "feedback.intakeStatus.github-created": "GitHub Issue erstellt",
  "feedback.intakeStatus.archived": "Archiviert",
  "feedback.error.preview": "Feedback-Vorschau konnte nicht erstellt werden.",
  "feedback.error.submit": "Feedback konnte nicht gesendet werden.",
  "feedback.preview": "Redigierte Payload-Vorschau",
  "feedback.preview.bytes": "{bytes} Bytes",
  "feedback.preview.redactions": "{count} Redaktionen",
  "feedback.queue.title": "Review-Queue",
  "feedback.queue.refresh": "Aktualisieren",
  "feedback.queue.refreshing": "Wird aktualisiert...",
  "feedback.queue.empty": "Kein Feedback wartet im Intake.",
  "feedback.queue.loaded": "{count} Intake-Eintraege geladen.",
  "feedback.queue.reviewed": "Review aktualisiert: {intakeId}",
  "feedback.queue.githubCreated": "GitHub Issue fuer {intakeId} erstellt",
  "feedback.queue.createGithub": "GitHub Issue erstellen",
  "feedback.queue.error.load": "Feedback-Intake konnte nicht geladen werden.",
  "feedback.queue.error.review": "Feedback-Review konnte nicht aktualisiert werden.",
  "feedback.queue.error.github": "GitHub Issue konnte nicht erstellt werden.",
  "feedback.review.request-follow-up": "Rueckfrage",
  "feedback.review.reject": "Ablehnen",
  "feedback.review.archive": "Archivieren",
  "feedback.review.approve-for-github": "Freigeben",
