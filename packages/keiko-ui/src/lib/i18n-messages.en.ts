export const EN_MESSAGES = {
  ...
  "feedback.subtitle":
    "Build a local report, review the redacted payload, then send it to the intake queue.",
  ...
  "feedback.category.documentation": "Documentation",
  ...
  "feedback.field.steps": "Reproduction steps",
  "feedback.field.expected": "Expected",
  "feedback.field.actual": "Actual",
  "feedback.field.featureArea": "Feature area",
  "feedback.action.preview": "Preview",
  "feedback.action.previewing": "Previewing...",
  "feedback.action.submit": "Submit Feedback",
  "feedback.action.submitting": "Submitting...",
  "feedback.status.previewing": "Building redacted preview...",
  "feedback.status.previewReady": "Preview ready. Review the payload before submitting.",
  "feedback.status.previewBlocked": "Preview is blocked and cannot be submitted.",
  "feedback.status.submitting": "Submitting redacted feedback...",
  "feedback.status.submitted": "Feedback submitted to intake: {intakeId}",
  "feedback.intakeStatus.new": "New",
  "feedback.intakeStatus.duplicate": "Duplicate",
  "feedback.intakeStatus.rejected": "Rejected",
  "feedback.intakeStatus.follow-up-requested": "Follow-up requested",
  "feedback.intakeStatus.approved-for-github": "Approved for GitHub",
  "feedback.intakeStatus.github-created": "GitHub issue created",
  "feedback.intakeStatus.archived": "Archived",
  "feedback.error.preview": "Could not build feedback preview.",
  "feedback.error.submit": "Could not submit feedback.",
  "feedback.preview": "Redacted payload preview",
  "feedback.preview.bytes": "{bytes} bytes",
  "feedback.preview.redactions": "{count} redactions",
  "feedback.queue.title": "Review queue",
  "feedback.queue.refresh": "Refresh",
  "feedback.queue.refreshing": "Refreshing...",
  "feedback.queue.empty": "No feedback is waiting in intake.",
  "feedback.queue.loaded": "{count} intake items loaded.",
  "feedback.queue.reviewed": "Review updated: {intakeId}",
  "feedback.queue.githubCreated": "GitHub issue created for {intakeId}",
  "feedback.queue.createGithub": "Create GitHub Issue",
  "feedback.queue.error.load": "Could not load feedback intake.",
  "feedback.queue.error.review": "Could not update feedback review.",
  "feedback.queue.error.github": "Could not create GitHub issue.",
  "feedback.review.request-follow-up": "Request follow-up",
  "feedback.review.reject": "Reject",
  "feedback.review.archive": "Archive",
  "feedback.review.approve-for-github": "Approve",
