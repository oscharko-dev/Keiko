export const EN_MESSAGES = {
  ...
  "editor.agentConflict.title.dirty": "Unsaved changes conflict",
  "editor.agentConflict.title.versionMismatch": "File version mismatch",
  "editor.agentConflict.title.contentHashMismatch": "File content mismatch",
  "editor.agentConflict.title.invalidEdits": "Invalid agent edits",
  "editor.agentConflict.title.outOfScope": "Action out of scope",
  "editor.agentConflict.title.noActiveSession": "No active editor session",
  "editor.agentConflict.title.noActiveBridge": "No live editor bridge",
  "editor.agentConflict.title.preconditionRequired": "Missing write precondition",
  "editor.agentConflict.title.policyDenied": "Action denied by policy",
  "editor.agentConflict.title.approvalRequired": "Action approval required",
  "editor.agentConflict.reload": "Reload",
  "editor.agentActions.panelLabel": "Recent agent editor actions",
  "editor.agentActions.title": "Recent agent actions",
  "editor.agentActions.filterGroup": "Filter recent agent actions",
  "editor.agentActions.filter.actionType": "Action type",
  "editor.agentActions.filter.disposition": "Disposition",
  "editor.agentActions.filter.timeRange": "Time range",
  "editor.agentActions.action.all": "All action types",
  "editor.agentActions.action.openFile": "Open file",
  "editor.agentActions.action.focusTab": "Focus tab",
  "editor.agentActions.action.moveTab": "Move tab",
  "editor.agentActions.action.splitPane": "Split pane",
  "editor.agentActions.action.setSelection": "Set selection",
  "editor.agentActions.action.format": "Format",
  "editor.agentActions.action.save": "Save",
  "editor.agentActions.action.applyTextEdits": "Apply text edits",
  "editor.agentActions.action.applyPatch": "Apply patch",
  "editor.agentActions.action.applyChangeset": "Apply changeset",
  "editor.agentActions.disposition.all": "All dispositions",
  "editor.agentActions.disposition.allowed": "Allowed",
  "editor.agentActions.disposition.reviewRequired": "Review required",
  "editor.agentActions.disposition.denied": "Denied",
  "editor.agentActions.timeRange.all": "All time",
  "editor.agentActions.timeRange.pastHour": "Past hour",
  "editor.agentActions.timeRange.pastDay": "Past 24 hours",
  "editor.agentActions.timeRange.pastWeek": "Past 7 days",
  "editor.agentActions.loadError": "Unable to load recent agent actions.",
  "editor.agentActions.empty": "No recent agent editor actions.",
  "editor.agentActions.noMatch": "No agent editor actions match the current filters.",
  "editor.agentActions.rowTarget": " on {path}",
