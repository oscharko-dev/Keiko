export const EN_MESSAGES = {
  ...
  "managedLanguage.title": "Language intelligence",
  "managedLanguage.description":
    "Manage workspace language servers, negotiated capabilities, health, and restart state.",
  "managedLanguage.noWorkspace": "Select a workspace to manage language intelligence.",
  "managedLanguage.loading": "Loading language intelligence...",
  "managedLanguage.loadFailed": "Language intelligence could not be loaded.",
  "managedLanguage.retry": "Retry",
  "managedLanguage.retryIntent": "Retry requested change",
  ...
  "managedLanguage.mutationFailed":
    "The requested change was not applied. Server state remains authoritative.",
  "managedLanguage.applying": "Applying workspace language change...",
  "managedLanguage.enabled": "Enable {language}",
  "managedLanguage.disabled": "Disable {language}",
  "managedLanguage.restart": "Restart {language}",
  "managedLanguage.reset": "Reset {language}",
  "managedLanguage.confirmTitle": "Confirm disruptive language change",
  "managedLanguage.confirmBody":
    "{action} may interrupt language features for open files in this workspace.",
  "managedLanguage.confirm": "Confirm {action}",
  "managedLanguage.cancel": "Cancel",
  "managedLanguage.actionEnable": "enable",
  "managedLanguage.actionDisable": "disable",
  "managedLanguage.actionRestart": "restart",
  "managedLanguage.actionReset": "reset",
  "managedLanguage.stateDisabled": "Disabled",
  "managedLanguage.stateDisabledByPolicy": "Disabled by policy",
  "managedLanguage.stateNotProvisioned": "Not provisioned",
  "managedLanguage.stateAvailable": "Available",
  "managedLanguage.stateStarting": "Starting",
  "managedLanguage.stateActive": "Active",
  "managedLanguage.stateDegraded": "Degraded",
  "managedLanguage.stateUnhealthy": "Unhealthy",
  "managedLanguage.stateRestartRequired": "Restart required",
  ...
  "managedLanguage.capabilities": "Negotiated capabilities",
  "managedLanguage.noCapabilities": "No executable capabilities were negotiated.",
  "managedLanguage.moreCapabilities": "{count} more capabilities",
  "managedLanguage.health": "Runtime health",
  "managedLanguage.healthSummary":
    "{status}; {success} successful requests; {failures} failures; maximum latency {latency} ms.",
  "managedLanguage.healthUnavailable": "No runtime health sample is available yet.",
  "managedLanguage.configuration": "Runtime settings",
  "managedLanguage.configured": "Configured",
  "managedLanguage.notConfigured": "Using governed defaults",
  "managedLanguage.source": "Settings source: {source}",
  "managedLanguage.sourceWorkspace": "workspace",
  "managedLanguage.sourceOperatorProvisioning": "operator provisioning",
  "managedLanguage.sourceBuiltInDefault": "built-in default",
  "managedLanguage.providerConfigurationSource": "Detected project configuration: {source}",
  "managedLanguage.restartImpact": "Restart impact: {fields}",
  "managedLanguage.restartRuntime": "runtime",
  "managedLanguage.restartSettings": "settings",
  ...
  "managedLanguage.goSettings":
    "Static analysis: {staticcheck}; build tags: {count}; target: {target}.",
  ...
  "managedLanguage.javaSettings": "Java source {source}, target {target}; project roots: {count}.",
  "managedLanguage.rustSettings":
    "Features: {count}; target: {target}; Cargo metadata: {metadata}.",
  "managedLanguage.valueEnabled": "enabled",
  "managedLanguage.valueDisabled": "disabled",
  "managedLanguage.valueDefault": "default",
  "managedLanguage.editTypeChecking": "Type-checking mode",
  "managedLanguage.editStaticcheck": "Enable static analysis",
  "managedLanguage.editDialect": "Shell dialect",
  "managedLanguage.editJavaSource": "Java source level",
  "managedLanguage.editJavaTarget": "Java target level",
  "managedLanguage.editRustTarget": "Rust target triple",
  "managedLanguage.saveSettings": "Save settings",
  ...
  "managedLanguage.reasonWorkspaceDisabled": "This workspace disabled the provider.",
  "managedLanguage.reasonWorkspaceUnset": "This workspace has not enabled the provider.",
  "managedLanguage.reasonAvailable": "The provider is provisioned and can be enabled.",
  "managedLanguage.reasonStarting": "The server is starting and negotiating capabilities.",
  "managedLanguage.reasonCapabilityMissing": "A required live capability was not negotiated.",
  "managedLanguage.reasonHealthUnknown": "Runtime health has not been established.",
  "managedLanguage.reasonDegraded": "The runtime reported degraded service.",
  "managedLanguage.reasonUnhealthy": "The runtime is unhealthy.",
  "managedLanguage.reasonRestartRequired": "Changed runtime settings require a controlled restart.",
  "managedLanguage.reasonActive": "The server is active with negotiated capabilities.",
  "managedLanguage.reasonStateUnavailable": "Server-owned settings could not be read safely.",
  "managedLanguage.reasonInvalid": "The server rejected an invalid state.",
  ...
  "quickAccess.empty.noRoot": "Open or select a project to search files.",
  "quickAccess.empty.startSearch": "Type to search files in the project.",
  "quickAccess.empty.files": "No matching files.",
  "quickAccess.title": "Quick access",
  "quickAccess.description": "Search files or run a command.",
  "quickAccess.query.commands": "Search commands",
  "quickAccess.query.files": "Search files",
  "quickAccess.placeholder.commands": "Type a command…",
  "quickAccess.placeholder.files": "Search project files…",
