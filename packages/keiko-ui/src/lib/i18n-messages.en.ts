export const EN_MESSAGES = {
  ...
  "editor.fileHistory.title": "File history",
  "editor.fileHistory.open": "Open file history",
  "editor.fileHistory.close": "Close file history",
  "editor.fileHistory.listLabel": "File restore points",
  "editor.fileHistory.loading": "Loading file history…",
  "editor.fileHistory.empty": "No restore points exist for this file yet.",
  "editor.fileHistory.unpaired": "Pair the local app session to read file history.",
  "editor.fileHistory.loadFailed": "File history could not be loaded.",
  "editor.fileHistory.retry": "Retry",
  "editor.fileHistory.pruned": "This restore point is no longer available.",
  "editor.fileHistory.origin.userSave": "User save",
  "editor.fileHistory.origin.agentApply": "Agent apply",
  "editor.fileHistory.origin.restore": "Restore",
  "editor.fileHistory.pinned": "Pinned",
  "editor.fileHistory.pin": "Pin restore point",
  "editor.fileHistory.unpin": "Unpin restore point",
  "editor.fileHistory.compareCurrent": "Compare with current",
  "editor.fileHistory.selectCompare": "Select for comparison",
  "editor.fileHistory.compareSelected": "Compare with selected",
  "editor.fileHistory.compareTitle": "File history comparison",
  "editor.fileHistory.closeCompare": "Back to file history",
  "editor.fileHistory.restore": "Restore",
  "editor.fileHistory.delete": "Delete",
  "editor.fileHistory.restoreTitle": "Restore this version?",
  "editor.fileHistory.restoreBody":
    "The current file will be checkpointed before this version is saved through the normal conflict checks.",
  "editor.fileHistory.deleteTitle": "Delete this restore point?",
  "editor.fileHistory.deleteBody":
    "This encrypted restore point cannot be recovered after deletion.",
  "editor.fileHistory.confirmRestore": "Restore version",
  "editor.fileHistory.confirmDelete": "Delete restore point",
  "editor.fileHistory.cancel": "Cancel",
  "editor.fileHistory.dirtyConflict":
    "Unsaved edits prevent restore. Save or discard the current buffer before restoring.",
  "editor.fileHistory.restoreFailed": "The version was not restored.",
  "editor.fileHistory.pinFailed": "The pinned state could not be changed.",
  "editor.fileHistory.deleteFailed": "The restore point could not be deleted.",
  "editor.fileHistory.sizeDelta": "Size change: {delta}",
  "editor.fileHistory.entryLabel": "Restore point {sequence}, {origin}, {timestamp}",
  ...
  "agentLauncher.scope.sourceFile": "Source file",
  "agentLauncher.scope.bugReport": "Bug report",
  "agentLauncher.sourceFilePlaceholder": "src/file.ts",
  "agentLauncher.browseSourceFile": "Browse source file",
  "agentLauncher.selectRepositoryFirst": "Select a repository before browsing source files.",
  "agentLauncher.observedBehavior": "Observed behavior",
  "agentLauncher.observedBehaviorPlaceholder": "Describe the observed bug.",
  "agentLauncher.failingOutput": "Failing output",
  "agentLauncher.stackTrace": "Stack trace",
  "agentLauncher.relatedFiles": "Related files",
  "agentLauncher.relatedFilesPlaceholder": "src/file.ts, src/other.ts",
  "agentLauncher.notRegistered": "Repository is not registered.",
  "agentLauncher.registering": "Registering…",
  "agentLauncher.register": "Register repository",
  "agentLauncher.useCurrentFile": "Use current file",
  "agentLauncher.loading": "Loading models and projects…",
  "agentLauncher.start": "Start {label}",
  "agentLauncher.starting": "Starting…",
  "agentLauncher.validation.repositoryRequired": "Repository is required.",
  "agentLauncher.validation.noModel": "No compatible model is available.",
  "agentLauncher.validation.explainFile": "Explain plan requires a file path.",
  ...
  "memoria.editProposal": "Edit proposal",
  ...
  "memoria.journal.title": "Memory Journal",
  "memoria.journal.description":
    "A recent, reversible record of what Keiko learned from your conversations.",
  "memoria.journal.loading": "Loading recent captures…",
  "memoria.journal.loaded": "{count} recent captures loaded",
  "memoria.journal.emptyTitle": "No recent captures",
  "memoria.journal.emptyBody":
    "New memories will appear here after MemoriaViva captures them from a conversation.",
  "memoria.journal.list": "Recent memory captures",
  "memoria.journal.contentUnavailable": "Memory content is unavailable",
  "memoria.journal.refusedBody": "Capture refused by policy. No content was retained.",
  "memoria.journal.surface": "Surface {surface}",
  "memoria.journal.surface.conversationCenter": "Conversation",
  "memoria.journal.surface.voice": "Voice",
  "memoria.journal.source": "Source {source}",
  "memoria.journal.reason": "Capture reason {reason}",
  "memoria.journal.capturedAt": "Captured {time}",
  "memoria.journal.mode.governedAssist": "Ask for approval",
  "memoria.journal.mode.supervisedCoding": "Supervised workspace",
  "memoria.journal.mode.autonomousDelivery": "Full access",
  "memoria.journal.mode.unknown": "Mode unavailable",
  "memoria.journal.indicator.proposed": "Awaiting review",
  "memoria.journal.indicator.auto": "Auto-captured",
  "memoria.journal.indicator.kept": "Kept",
  "memoria.journal.indicator.refused": "Refused",
  "memoria.journal.keep": "Keep",
  "memoria.journal.keeping": "Keeping…",
  "memoria.journal.forget": "Forget",
  "memoria.journal.forgetting": "Forgetting…",
  "memoria.journal.kept": "Memory kept",
  "memoria.journal.forgotten": "Memory forgotten",
  "memoria.journal.keepError": "The memory could not be kept. Retry the action.",
  "memoria.journal.forgetError": "The memory could not be forgotten. Retry the action.",
  ...
  "memoria.consolidation.applyProposal": "Apply proposal",
  "memoria.consolidation.applying": "Applying...",
  "memoria.consolidation.proposalApplied": "Consolidation proposal applied.",
  "memoria.consolidation.localExcerpts": "Bounded local memory excerpts",
  "memoria.consolidation.excerptTruncated": " (truncated)",
  ...
  "filesWidget.multiRoot.label": "Workspace roots",
  "filesWidget.multiRoot.manage": "Manage workspace roots",
  "filesWidget.multiRoot.project": "Project to add",
  "filesWidget.multiRoot.chooseProject": "Choose a registered project",
  "filesWidget.multiRoot.add": "Add root",
  "filesWidget.multiRoot.focus": "Focus root: {name}",
  "filesWidget.multiRoot.focused": "Focused",
  "filesWidget.multiRoot.focusAction": "Focus",
  "filesWidget.multiRoot.moveUp": "Move root up: {name}",
  ...
  "gitClientWindow.sync.result.succeeded": "succeeded",
  "gitClientWindow.sync.result.upToDate": "already up to date",
  "gitClientWindow.sync.result.noRemote": "no remote is configured",
  "gitClientWindow.sync.result.noUpstream": "no upstream branch is configured",
  "gitClientWindow.sync.result.detachedHead": "HEAD is detached",
  "gitClientWindow.sync.result.dirtyWorktree": "local changes would be overwritten",
  "gitClientWindow.sync.result.notFastForward": "the branches have diverged",
  "gitClientWindow.sync.result.authFailed": "the credentials were rejected",
  "gitClientWindow.sync.result.untrustedHostKey": "the host key is not trusted",
  "gitClientWindow.sync.result.remoteUnavailable": "the remote could not be reached",
  "gitClientWindow.sync.result.timeout": "it did not finish in time",
  "gitClientWindow.sync.result.outputTruncated": "it was stopped at the output limit",
  "gitClientWindow.sync.result.gitMissing": "Git is not available",
  "gitClientWindow.sync.result.unsafeRepository": "Git refused this repository's ownership",
  "gitClientWindow.sync.result.gitError": "Git reported an error",
  "gitClientWindow.sync.result.blockedByPolicy": "blocked by policy",
  "gitClientWindow.sync.result.approvalRequired": "approval is required",
  "gitClientWindow.sync.result.failed": "failed",
  "gitClientWindow.sync.result.recoveryRequired": "recovery is required",
  "gitClientWindow.sync.rejectionSuffix": " — {reason}",
  "gitClientWindow.sync.hintSuffix": " {hint}",
  "gitClientWindow.sync.rejection.nonFastForward": "the remote has newer commits",
  "gitClientWindow.sync.rejection.fetchFirst": "the remote has newer commits",
  "gitClientWindow.sync.rejection.noUpstream": "no upstream branch is configured",
  "gitClientWindow.sync.rejection.authFailed": "the credentials were rejected",
  "gitClientWindow.sync.rejection.permissionDenied": "access to the remote was refused",
  "gitClientWindow.sync.rejection.protectedRef": "the target branch is protected",
  "gitClientWindow.sync.rejection.remoteUnavailable": "the remote could not be reached",
  "gitClientWindow.sync.rejection.unknown": "the remote rejected the push",
