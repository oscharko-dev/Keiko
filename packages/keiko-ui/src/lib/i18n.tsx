...
const DE_MESSAGES: Record<MessageKey, string> = {
  ...
  "chat.memory.budgetStepper": "MemoriaViva-Budget",
  "chat.memory.budgetHelp":
    "Begrenzt nur den MemoriaViva-Speicherkontext fuer die naechste Modellanfrage. Es ist weder das Modell-Kontextfenster noch Antwortlimit oder Kostenbudget.",
