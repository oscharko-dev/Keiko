...
// Full script coverage recorded 19.6 s under the bounded two-worker scheduler. Preserve the 15 s
// repository default and give only this subprocess-heavy suite a bounded, evidence-based margin.
