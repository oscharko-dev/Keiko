...
const CODERABBIT_POLICY_DIGEST = "04eef50a86fbbe124db1eccb009370add098a353fc644d5134827872d257bd54";
const CODERABBIT_TEXT_CHECKS = [
  ...
  [
    'files: "docs/adr/ADR-0019-modular-package-architecture.md,docs/adr/ADR-0129-product-wide-authority-and-autonomy-model.md,docs/adr/ADR-0131-ci-based-sonarcloud-analysis-and-banking-grade-gate.md,docs/adr/ADR-0135-deterministic-dev-delivery-and-keiko-for-quality.md,docs/adr/ADR-0167-zero-cost-autonomous-quality-gates.md,docs/adr/ADR-0168-quota-tolerant-review-settlement.md,docs/adr/ADR-0169-retire-codspeed-and-greptile.md"',
