...
export function packRoot() {
  ...
  // Vendored workspaces only: third-party runtime dependencies are declared, never embedded, and
  // release-publish.mjs stages the same way (#3565, release-publish-tarball-parity.test.mjs).
