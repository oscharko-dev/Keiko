import { TOOL_BUDGET_DISPOSITIONS } from "../../packages/keiko-contracts/dist/governed-tool-lifecycle.js";
...
function checkPinnedValues(contract, errors) {
  if (!sameSet(contract.budgetDispositions, TOOL_BUDGET_DISPOSITIONS))
    errors.push("budgetDispositions: vocabulary differs");
