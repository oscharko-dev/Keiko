 ...
 * verification, keiko-ui internals, and the Node-only Activity Log package.
 * `scripts/arch-check-negative.mjs` proves the rule fires by name for each edge (expected count:
 * 11 — the eight ADR-0042 baseline targets plus keiko-quality-intelligence,
 * keiko-local-knowledge, and keiko-activity-log). This Activity Log edge also proves the
 * ADR-0179 domain-package prohibition for the editor source set.
 *
