...
const publicPort = Number(process.env.KEIKO_E2E_UI_PORT ?? "32214");
const stateId = process.env.GITHUB_RUN_ID ?? `issue-2074-feedback-ui-${String(process.pid)}`;
...
export default defineConfig({
  ...
  testMatch: /feedback-intake-2074\.spec\.ts/u,
  fullyParallel: false,
  workers: 1,
  timeout: 600_000,
