...
import { createFakeLspProcess } from "../packages/keiko-server/src/editor/lsp/testing/fakeLspProcess.js";
...
async function createFixture(onLspMessage?: (method: string) => void): Promise<Fixture> {
  ...
  const deps = {
    ...
    editorLanguageRouteOptions: {
      ...
      hostLanguageSpawn: managedSpawn(spawnedMethods, root, onLspMessage),
    },
