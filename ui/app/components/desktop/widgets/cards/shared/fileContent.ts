...
export const FILE_CONTENT: Readonly<Record<string, string>> = {
  ...
  "application.yml":
    "server:\n  port: 8443\nspring:\n  application:\n    name: orca-intelligence\n  datasource:\n    url: jdbc:postgresql://db.corp.local:5432/orca\nkeiko:\n  models:\n    chat: https://llm.corp.local/v1   # internal, behind firewall\n    embedding: https://embed.corp.local/v1",
  "Dockerfile":
...
export function stub(name: string, lang: Lang): string {
  ...
  if (lang === "props") {
    return (
      "# " +
      name +
      "\nkeiko.mode=autonomous\nkeiko.model.chat=https://llm.corp.local/v1"
    );
  }
  return "// " + name + "\n// preview";
}
