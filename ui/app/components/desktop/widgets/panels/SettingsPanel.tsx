          ...
          <>
            ...
            <div className="ml-row">
              ...
              <div className="ml-info">
                ...
                <div className="ml-url mono">
                  {connected
                    ? "Keiko can use the configured internal models for chat and agent workflows."
                    : "Enter the internal base URL and API token before using chat or agent workflows."}
                </div>
              </div>
            ...
            {loadingModels ? (
              ...
              <div className="set-placeholder">
                No models are configured yet. Connect the gateway to load customer-hosted model capabilities.
              </div>
            ) : (
