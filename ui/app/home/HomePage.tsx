...
function SurfaceCard({ href, title, description }: SurfaceCardProps): ReactNode {
  return (
    <li>
      <Link
        href={href}
    ...
    <section aria-labelledby="home-heading">
      ...
      <div className="border-b border-ink/10 pb-section">
        ...
        <p className="mt-3 max-w-2xl text-ink-muted">
          ...
          workflows. Everything runs on your machine — no external service is contacted beyond the
        ...
        <ol className="mt-4 grid gap-2 text-sm text-ink-muted">
          <li className="flex gap-2">
            ...
            <span>
              ...
              <Link
                href="/launch"
                className="text-accent hover:underline focus:outline-none focus:ring-1 focus:ring-focus"
              >
                Launch workflow
              </Link>
